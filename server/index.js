...
export default function Host() {
    ...
    useEffect(() => {
        ...
        // logical (CSS pixel) viewport size — all drawing math below uses this,
        // while the canvas's actual pixel buffer is rendered at devicePixelRatio
        // for crisper sprites/text without changing how big anything looks
        ...
        function drawHUD() {
            ...
            function badge(theme: typeof TEAM_THEME.shark, mascotImg: HTMLImageElement, gold: number, align: "left" | "right") {
                const x = align === "left" ? padding : view.w - padding - badgeW;
                const y = padding;
        ...
        function drawWinnerScreen(now: number) {
            ...
            const glowR = Math.min(view.w, view.h) * 0.32;
            ...
            const spriteSize = Math.min(view.w, view.h) * 0.34 * popT;
            ctx.save();
        ...
        function loop(now: number) {
            ...
            if (bgImg.complete) {
                ctx.drawImage(bgImg, 0, 0, view.w, view.h);
            }
